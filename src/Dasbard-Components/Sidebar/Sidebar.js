        ...
        <div className='sidebar__menu'>
            ...
            <div className='sidebar__link'>
                <Link to={`/admin/${params}`} onClick={(e)=>{
                    e.preventDefault()
                    setDashboard(1)
                }}><BiFoodMenu color="white" className="icons-style" />Eventos</Link>               
            </div>
            <div className='sidebar__link'>
                <Link to={`/admin/${params}`} onClick={(e)=>{
                    e.preventDefault()
                    setDashboard(2)
                }}><AiOutlinePlusCircle color="white" className="icons-style"/>CRUD</Link>               
            </div>
            <div className='sidebar__link'>
                <Link to={`/admin/${params}`} onClick={(e)=>{
                    e.preventDefault()
                    setDashboard(3)
                }}><FiUserCheck color="white" className="icons-style"/>Clientes</Link>               
            </div>
            <div className='sidebar__link'>
                <Link to={`/admin/${params}`} onClick={(e)=>{
                    e.preventDefault()
                    setDashboard(4)
                }}><BiMoney color="white" className="icons-style" />Afiliados</Link>               
            </div>
            <h2>Plataforma</h2>
            <div className='sidebar__link'>
                <Link to={`/admin/${params}`} onClick={(e)=>{
