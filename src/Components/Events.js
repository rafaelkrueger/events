    ...
    <>
        <div className="event-component">
            <div className="event-cards">
                {eventos == undefined?'':eventos.map((list)=>{
                return(
                    <>
                    ...
                    return(
                        ...
                        <img src={subItems.image} alt="..." id="event-card-image"/>
                            <div class="card-body">
                                <h6 id="event-card-title">{subItems.name}</h6>
                                <p id="event-card-description" class="card-text">{subItems.description}</p>
                                <Link to={`/eventos/${subItems._id}`} id="event-card-button">ADQUIRIR</Link>
                            </div>
                        </div>                    
                        </>                        
                    )                        
